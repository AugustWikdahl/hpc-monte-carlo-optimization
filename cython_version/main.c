...
static double __pyx_f_4main_c_gaussian(void); /*proto*/
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_4main_mc_price_cython(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_S0, double __pyx_v_K, double __pyx_v_r, double __pyx_v_sigma, double __pyx_v_T, int __pyx_v_M, int __pyx_v_I); /* proto */
...
#define __pyx_kp_u_main_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_K __pyx_string_tab[5]
...
#define __pyx_n_u_S0 __pyx_string_tab[9]
...
#define __pyx_n_u_drift __pyx_string_tab[13]
#define __pyx_n_u_dt __pyx_string_tab[14]
...
#define __pyx_n_u_main_2 __pyx_string_tab[20]
#define __pyx_n_u_mc_price_cython __pyx_string_tab[21]
...
#define __pyx_n_u_payoff __pyx_string_tab[26]
...
#define __pyx_kp_b_iso88591_e1_Rr_2T_5_Rq_fBd_1_q_U_1_A_E_a __pyx_string_tab[40]
...
static double __pyx_f_4main_c_gaussian(void) {
  double __pyx_v_u1;
  double __pyx_v_u2;
  double __pyx_r;
  int __pyx_t_1;
...
*/
  ...
  __pyx_v_u1 = (((double)__pyx_t_1) / __pyx_t_2);
...
*/
  ...
  __pyx_v_u2 = (((double)__pyx_t_1) / __pyx_t_2);
...
*/
  __pyx_r = (sqrt((-2.0 * log(__pyx_v_u1))) * cos(((2.0 * M_PI) * __pyx_v_u2)));
  goto __pyx_L0;
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("main.c_gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_4main_1mc_price_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_4main_1mc_price_cython = {"mc_price_cython", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4main_1mc_price_cython, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4main_1mc_price_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("mc_price_cython (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_S0,&__pyx_mstate_global->__pyx_n_u_K,&__pyx_mstate_global->__pyx_n_u_r,&__pyx_mstate_global->__pyx_n_u_sigma,&__pyx_mstate_global->__pyx_n_u_T,&__pyx_mstate_global->__pyx_n_u_M,&__pyx_mstate_global->__pyx_n_u_I,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "mc_price_cython", 0) < (0)) __PYX_ERR(0, 19, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 7; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("mc_price_cython", 1, 7, 7, i); __PYX_ERR(0, 19, __pyx_L3_error) }
      }
    ...
    __pyx_v_S0 = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_S0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_K = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_K == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_r == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_sigma = __Pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_sigma == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_T = __Pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_T == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_M = __Pyx_PyLong_As_int(values[5]); if (unlikely((__pyx_v_M == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_I = __Pyx_PyLong_As_int(values[6]); if (unlikely((__pyx_v_I == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("mc_price_cython", 1, 7, 7, __pyx_nargs); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("main.mc_price_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4main_mc_price_cython(__pyx_self, __pyx_v_S0, __pyx_v_K, __pyx_v_r, __pyx_v_sigma, __pyx_v_T, __pyx_v_M, __pyx_v_I);
...
static PyObject *__pyx_pf_4main_mc_price_cython(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_S0, double __pyx_v_K, double __pyx_v_r, double __pyx_v_sigma, double __pyx_v_T, int __pyx_v_M, int __pyx_v_I) {
  double __pyx_v_dt;
  double __pyx_v_drift;
  double __pyx_v_vol;
  double __pyx_v_total_payoff;
  double __pyx_v_S;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("mc_price_cython", 0);
...
*/
  ...
  __pyx_t_6 = __Pyx_PyLong_As_unsigned_int(__pyx_t_1); if (unlikely((__pyx_t_6 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  srand(((unsigned int)__pyx_t_6));
...
*/
  ...
  __pyx_v_dt = (__pyx_v_T / ((double)__pyx_v_M));
...
*/
  __pyx_v_drift = ((__pyx_v_r - (0.5 * pow(__pyx_v_sigma, 2.0))) * __pyx_v_dt);
...
*/
  __pyx_v_vol = (__pyx_v_sigma * sqrt(__pyx_v_dt));
 ...
 * 
*/
      __pyx_v_z = __pyx_f_4main_c_gaussian();
 ...
 *         payoff = S - K
*/
      __pyx_v_S = (__pyx_v_S * exp((__pyx_v_drift + (__pyx_v_vol * __pyx_v_z))));
    }
 ...
 *             total_payoff += payoff
*/
    __pyx_v_payoff = (__pyx_v_S - __pyx_v_K);
...
*/
      __pyx_v_total_payoff = (__pyx_v_total_payoff + __pyx_v_payoff);
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_14 = (exp(((-__pyx_v_r) * __pyx_v_T)) * __pyx_v_total_payoff);
  if (unlikely(__pyx_v_I == 0)) {
    PyErr_SetString(PyExc_ZeroDivisionError, "float division");
    __PYX_ERR(0, 44, __pyx_L1_error)
  }
  __pyx_t_1 = PyFloat_FromDouble((__pyx_t_14 / ((double)__pyx_v_I))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 *     # Seed the C RNG so it's not the same every time
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4main_1mc_price_cython, 0, __pyx_mstate_global->__pyx_n_u_mc_price_cython, NULL, __pyx_mstate_global->__pyx_n_u_main_2, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_mc_price_cython, __pyx_t_2) < (0)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{8},{39},{34},{1},{1},{1},{20},{1},{2},{1},{18},{18},{5},{2},{8},{1},{13},{5},{8},{4},{15},{10},{8},{2},{5},{6},{3},{12},{1},{12},{10},{5},{1},{8},{4},{12},{6},{3},{1},{168}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (435 bytes) */
const char* const cstring = "BZh91AY&SY\237\r\324I\000\000(\177\363\367|s$\374\001r\200\276+~\000\277\357\377p@@@@@@\000@@\000@\0000\001VR\301\024\320#Lh@\332\200\000\001\2404\0324h4\320\3325\006\246\210\304\305\r\251\250\3654=L!\243 \003\010`\023A\210\375@\324\302\236\204L\247\251\344\236\223C@\000\000\000\000\032z\230A\211\360\327\372[?\204\004\r\006\010nTfL\242G\2468\311\017*\200\227\"\301\332\224\020If\206\021\346)|\"a\r\203za%\360\204\010\202\034\373D\025B\242D\361\365\366_s)Q7\272q\334\226\020\3751\336T\257\306J\302\342,\204\303\2442@\025\246\351\013\024\246\035,m\250ct2\301Fn\264\205I(\236\211gb\331\265\0053\315\301\031\326\037\376V[POH\323\323$\r\274\361HEz\221\017\311\250\361\005@\275UGb\\\nUZS\330\026`a\253P\227VsL\331\202\"\002\243\351\343,\227Y\320\220\202\2729\350\"\\\263\275\373\222\000\232\331\230\010-\366\032\233\315X\004\037`\246\246\325\343hA\031\347\350\344\352*\"s\234)W8\254An\232\263\003\016\024\316\031\233\025\tqUUT\350\221\002\002\365\301DR\224K\2659\262\0346\000L\260\013L\244\005I\000B\202'\256n<\236\177a\334\013M\360\352\374\206/w\226\010\202?B\024#\250\357F\261{m\326\007\025\346\"\226?\320@\3412-\n\216H\310\024\215\335\220\3020\304\007\330O\000\277\213\271\"\234(HO\206\352$\200";
...
const char* const cstring = "x\332eOMO\302@\020\005R\010b\017B\202\211\211\211\240\236\033!1\036\r\240\007c4\nx\236,\333\255l\354v\333\355\226PO\036{\334\343\036{\344'\365\310O\340'\270\2001&N2o&\363\336|\3352D\003'L\227A\302\302\324\001\314\005qX\342K\212\204@i\307C\324'nG\362\016e!\027\362\257,aH\316\377)\036\036\237\000^\322\245\361;\212%<\223\245\034\023o2\271\232\2428\r0\345\216\351\346\211\244\001\211\261o\020h\000R Lf\010\177\270\202z\322\225\000^\022`\000\n4\206_=\225\204\305\000\333\233\367\3100\204\202b\0028\225s\276-r7\361\t\030\013\02031\010w\027\207(\345\236\027\362\020 J\220\277\347\004@L\344\217\320d.\361\220\371<\246\357\3461\000I\342-RF$\227\310\207\375\214\005\362\023\022/\270\377\371U\336\324J\325F\326\312n\365\245&yom\265\325X\t\335,\254\023\335\322}=\315[\371\365\252\262\272X\215WQa\035+O\017\265\233w\363^a\235\351hc\227\252\007Y5{S]\325+\352v6\330\302\275j+\244\242\265}\244\032\272[\230PQ\347j\244\"]\323\263\334\312\2079Z\327\233\252\245\372\352\265\250\037f7\206\035\024\366\251\036\254-;\033e\221*\357\310\211\256h\307,\357~\003\275\333\273\376";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (483 bytes) */
const char* const bytes = "?main.pyxnumpy._core.multiarray failed to importnumpy._core.umath failed to importIKM__Pyx_PyDict_NextRefSS0Tasyncio.coroutinescline_in_tracebackdriftdt__func__i_is_coroutineitems__main__mainmc_price_cython__module____name__npnumpypayoffpop__qualname__r__set_name__setdefaultsigmat__test__timetotal_payoffvaluesvolz\200\001\360\006\000\005\n\210\022\210?\230$\230e\2401\340\004\025\220R\220r\230\021\330\004\031\230\022\2302\230T\240\022\2405\250\002\250#\250R\250q\330\004\026\220f\230B\230d\240!\2401\330\004\037\230q\360\014\000\005\t\210\005\210U\220!\2201\330\010\014\210A\330\010\014\210E\220\025\220a\220q\340\014\020\220\n\230!\330\014\020\220\002\220\"\220C\220q\230\006\230b\240\004\240B\240a\340\010\021\220\022\2202\220Q\330\010\013\2107\220\"\220A\330\014\034\230A\340\004\014\210C\210q\220\001\220\022\2202\220S\230\002\230.\250\002\250!";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {7, 0, 0, 16, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 19};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_S0, __pyx_mstate->__pyx_n_u_K, __pyx_mstate->__pyx_n_u_r, __pyx_mstate->__pyx_n_u_sigma, __pyx_mstate->__pyx_n_u_T, __pyx_mstate->__pyx_n_u_M, __pyx_mstate->__pyx_n_u_I, __pyx_mstate->__pyx_n_u_dt, __pyx_mstate->__pyx_n_u_drift, __pyx_mstate->__pyx_n_u_vol, __pyx_mstate->__pyx_n_u_total_payoff, __pyx_mstate->__pyx_n_u_S, __pyx_mstate->__pyx_n_u_payoff, __pyx_mstate->__pyx_n_u_z, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u_t};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_main_pyx, __pyx_mstate->__pyx_n_u_mc_price_cython, __pyx_mstate->__pyx_kp_b_iso88591_e1_Rr_2T_5_Rq_fBd_1_q_U_1_A_E_a, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
